...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf riot-todo-temp && mkdir riot-todo-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r riot-todo-temp/* riot-todo/ && rm -rf riot-todo-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd riot-todo && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `riot-todo-temp` folder.');
